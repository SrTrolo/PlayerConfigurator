...
public class PlayerPrefsX
{
    ...
    public static bool SetulongArray(String key, ulong[] intArray)
    {
        return SetValue(key, intArray, ArrayType.Int32, 1, ConvertFromuLong);
    }
    ...
    public static ulong[] GetuLongArray(String key)
    {
        var intList = new List<ulong>();
        GetValue(key, intList, ArrayType.Int32, 1, ConvertToInt);
        return intList.ToArray();
    }
    ...
    public static bool SetuLongList(String key, List<ulong> intList)
    {
        ulong[] convertList = intList.ToArray();
        return SetulongArray(key, convertList);
    }
    ...
    public static List<ulong> GetuLongList(String key)
    {
        List<ulong> convertList = new List<ulong>(GetuLongArray(key));
        return convertList;
    }
    ...
    private static void ConvertFromuLong(ulong[] array, byte[] bytes, int i)
    {
        Convertulong32ToBytes(array[i], bytes);
    }
    private static void ConvertToInt(List<int> list, byte[] bytes)
    {
        list.Add(ConvertBytesToInt32(bytes));
    }
    private static void ConvertToInt(List<ulong> list, byte[] bytes)
    {
        list.Add(ConvertBytesTouLong(bytes));
    }
    ...
    private static void Convertulong32ToBytes(ulong i, byte[] bytes)
    {
        byteBlock = System.BitConverter.GetBytes(i);
        ConvertTo4Bytes(bytes);
    }
    ...
    {
        ConvertFrom4Bytes(bytes);
        return System.BitConverter.ToUInt32(byteBlock, 0);
    }
